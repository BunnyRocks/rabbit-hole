...
- File path `Interview Preparation/OA/Design Foo.md` → `Interview Prep::OA::Design Foo`
- File path `Interview Preparation/System Design/Caching.md` → `Interview Prep::System Design::Caching`
...
```yaml
deck: "Interview Prep::OA::Design In-memory Database"
